	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Sortie</li>
								</ol>
							</nav>
						</div>
						<div class="col-md-12 col-sm-12 text-right">
							...
							<div class="modal-content">
								...
								<div class="modal-body col-md-12">						
									<form id="forme" method="POST" Action="saveclient.php" class="form-horizontal col-md-12" autocomplete="off">										
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mt-3">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="tel" class="form-control" placeholder="+243 ... ... ..." name='telephone' required />
                                                    </div>                             
                                                    <div class="form-group">
				...
				<a class="btn btn-primary offset-8" href="fpdf/tutorial/sortie.php">Imprimer</a>	
					<div class="pd-20">
					...
					<div class="pb-20">
						<table class="data-table table stripe hover nowrap">
							...
							<div class="modal-content">
								...
								<div class="modal-body col-md-12">						
									<form id="forme_edit" method="POST" Action="editSortie.php" class="form-horizontal" autocomplete="off">
									<input type="hidden" name="id" id="id" value="<?=$lig->id ;?>" class="form-control" required/>										
                                        <div class="row">
                                            ...
                                            <div class="col-md-6  mt-3 text-left">  
                                                <div class="form-group">
                                                    <label for="prix">Prix unitaire</label>
                                                    <input type="number" class="form-control" placeholder="Prix unitaire" name="prix" min="0" value="<?=$lig->prix ;?>"/>
                                                </div>                       
                                                <div class="form-group">
                                                    <label for="devise">Devise</label>
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												...
												<a class="dropdown-item" onclick= "return (confirm(' Voulez-vous supprimer vraiment cette information ?'));"  href="deleteSortie.php?id=<?= $lig->id;?>"><i class="dw dw-delete-3"></i> Delete</a>											
											</div>
										</div>
									</td>
								</tr>
