					...
					<div class="pb-20">
						<table class="data-table table stripe hover nowrap">
							...
							<div class="modal-content">
								...
								<div class="modal-body col-md-12">						
									<form id="forme_edit" method="POST" Action="editclient.php" class="form-horizontal" autocomplete="off">
									<input type="hidden" name="id" id="id" value="<?=$lig->id ;?>" class="form-control" required/>										
									    <div class="row">
                                            <div class="col-md-6 mt-3">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select  class="form-control" name='sexe' value="<?=$lig->sexe ;?>" required >
                                                            <option value="<?=$lig->sexe ;?>"><?=$lig->sexe ;?></option>                                                           
                                                            <option value="<?=$lig->sexe ;?>"><?=$lig->sexe ;?></option>                                                           
                                                    </select>
                                                </div>                                                 
                                            </div>
                                            <div class="col-md-6 mt-3">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="telephone">Telephone</label>
                                                        <input type="tel" class="form-control" min="0" placeholder="+243 ... ... ..." oninput="this.value = Math.abs(this.value)" name='telephone' value="<?=$lig->telephone ;?>" required />
                                                    </div>                             
                                                    <div class="form-group">
                                                        <label for="adresse">Email</label>
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												...
												<a class="dropdown-item" onclick= "return (confirm(' Voulez-vous supprimer vraiment cette information ?'));"  href="deleteclient.php?id=<?= $lig->id;?>"><i class="dw dw-delete-3"></i> Delete</a>											
											</div>
										</div>
									</td>
								</tr>
