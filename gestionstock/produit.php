<?php
    ...
    $query1 = $db->query("SELECT designation FROM categorie");
	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				<div class="page-header">
					<div class="row">
						...
						<div class="col-md-12 col-sm-12 text-right">
                            <div class="container">
                                <form id="forme" method="POST" Action="saveProduit.php" class="form-horizontal col-md-12" autocomplete="off">
                                    <div class="row">
                                        <div class="col-md-6  mt-3 text-left">                          
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" placeholder="Prix unitaire" name="prix" oninput="this.value = Math.abs(this.value)" min="0" required/>
                                            </div>                      
										...
										<div class="form-group">                               
                                            <input type="submit" class="btn btn-primary col-md-4 mt-3 mr-5" value="Enregistrer" required/>
                                        </div>
                                </form>
                            <div>							
							...
							<div class="modal-content">
								...
								<div class="modal-body col-md-12">						
									<form id="forme" method="POST" Action="savecategorie.php" class="form-horizontal col-md-12" autocomplete="off">									
                                            <div class=" mt-3">
                                                <div class="form-group">
                                                    <label for="designation">Designation</label>
                                                    <input type="text" class="form-control" placeholder="designation" name='designation' required />
                ...
                <button data-toggle="modal" data-target="#myModal" class="btn btn-primary">Add categorie</button>
					...
					<div class="pb-20">
						<table class="data-table table stripe hover nowrap">
							...
							<div class="modal-content">
								...
								<div class="modal-body col-md-12">						
									<form id="forme_edit" method="POST" Action="editProduit.php" class="form-horizontal" autocomplete="off">
									<input type="hidden" name="id" id="id" value="<?=$lig->id ;?>" class="form-control" required/>										
                                        <div class="row">
                                            <div class="col-md-6  mt-3 text-left">                         
                                                ...
                                                <div class="form-group">
                                                    <label for="designation">Designation</label>
                                                    <input type="text" class="form-control" placeholder="designation" name="designation" value="<?=$lig->designation ;?>" required/>
                                                </div>                         
                                                <div class="form-group">
                                                    <label for="quantite">Quantité</label>
                                                    <input type="number" class="form-control" placeholder="quantité" name="quantite" min="0" oninput="this.value = Math.abs(this.value)" value="<?=$lig->quantite ;?>" required/>
                                                </div>    
                                                <div class="form-group">
                                                    <label for="prix">Prix unitaire</label>
                                                    <input type="number" class="form-control" placeholder="Prix unitaire" name="prix" min="0" oninput="this.value = Math.abs(this.value)" value="<?=$lig->prix ;?>" required/>
                                                </div>                       
                                            ...
                                            <div class="col-md-6  mt-3 text-left"> 
                                                ...
                                                <div class="form-group">
                                                    <label for="date">Date</label>
                                                    <input type="date" class="form-control" placeholder="date" name="dateoperation" value="<?=$lig->dateoperation ;?>" required/>
                                                </div> 
                                                <div class="form-group">
                                                    <label for="categorie">Categorie</label>
                                                    <select class="form-control" name="categorie" value="<?=$lig->categorie ;?>">
                                                        <optgroup >																						
                                                            <option value="<?=$lig->categorie ;?>"><?=$lig->categorie ;?></option>                                                           														
                                                        </optgroup>	
                                                    </select>
                                                </div>                                                                    
                                            </div>
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">										
												...
												<a class="dropdown-item" onclick= "return (confirm(' Voulez-vous supprimer vraiment cette information ?'));"  href="deleteproduit.php?id=<?= $lig->id;?>"><i class="dw dw-delete-3"></i> Delete</a>											
											</div>
										</div>
									</td>
								</tr>
