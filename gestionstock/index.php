<?php
  ...
  $query=$db->query("SELECT COUNT(*) AS id FROM users");
  $query1=$db->query("SELECT totalappro FROM vapprovision ");
  $query2=$db->query("SELECT totalproduit FROM totalproduit");
  $query3=$db->query("SELECT totalsortie FROM totalsortie");
  $query4 = $db->query("SELECT * FROM view_alerte");
?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="card">
          <div class="card-body">
			...
			<?php while ($b = $query2->fetch()) {?>			
				...
				<h5 class="text-center"><?=$b['totalproduit'];?></h5>
          ...
          <div class="card-body">		 
			...
			<?php while ($b = $query1->fetch()) {?>	
				<div class="col-11 col-md-12 col-xl-11">
					<h5 class="text-center"><?=$b['totalappro'];?></h5>
        ...
        <div class="card">
          <div class="card-body">
			...
			<?php while ($b = $query3->fetch()) {?>
				<div class="col-10 col-md-12 col-xl-10">
					<h5 class="text-center"><?=$b['totalsortie'];?></h5>
