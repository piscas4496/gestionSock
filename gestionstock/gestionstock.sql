...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 06 mai 2022 à 09:46
...
INSERT INTO `personnel` (`id`, `nom`, `postnom`, `prenom`, `sexe`, `datenaiss`, `etatcivil`, `adresse`, `telephone`, `mail`) VALUES
(1, 'Charline', 'Batumike', 'Angel', 'F', '1997-10-21', 'MariÃ©', 'Goma/himbi 2', '0972134839', 'charline@gmail.com');
...
DROP VIEW IF EXISTS `totalstock`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `totalstock`  AS  select sum(`stock`.`SI`) AS `Totalstock` from `stock` ;
