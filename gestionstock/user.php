				...
				<div class="page-header">
					<div class="row">
						...
						<div class="col-md-6 col-sm-12 text-right">							
								<button data-toggle="modal" data-target="#myModal" class="btn btn-primary">Add user</button>
							
							<div id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
							<div role="document" class="modal-dialog">
							<div class="modal-content col-md-12">
								<div class="modal-header">
									<h5 id="exampleModalLabel" class="modal-title">Add users</h5>
									<button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
								</div>
								<div class="modal-body">						
									<form id="forme" method="POST" Action="adduser.php" class="form-horizontal" autocomplete="off">										
										<div class="row">
											<div class="col-md-11 ml-3">
												<div class="form-group">
													<label for="nom">Noms</label>
													<input type="text" class="form-control" placeholder="names" name="noms" required/>
												</div>
												<div class="form-group">
					...
					<div class="pb-20">
						<table class="data-table table stripe hover nowrap">
							...
							<div class="modal-content">
								<div class="modal-header">
									<h5 id="exampleModalLabel" class="modal-title">Update utilisateur</h5>
									<button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
								</div>
								<div class="modal-body">						
									<form id="forme_edit" method="POST" Action="updateuser.php" class="form-horizontal" autocomplete="off">
									<input type="hidden" name="id" id="id" value="<?=$lig->id ;?>" class="form-control" required/>										
									<div class="row">
											<div class="col-md-11 ml-3">
												<div class="form-group">
													<label for="nom">Noms</label>
													<input type="text" class="form-control" placeholder="names" name="noms" value="<?=$lig->noms ;?>" required/>
												</div>
												<div class="form-group">
													<label for="username">Username</label>
													<input type="text" class="form-control" placeholder="username" name="username" value="<?=$lig->username ;?>" required/>
												</div>                                                                               
											
												<div class="form-group">
													<label for="password">Password</label>
													<input type="password" class="form-control" placeholder="Password" name="password" value="<?=$lig->password ;?>" required/>
												</div>  
												<div class="form-group">
													<label for="role">Role</label>
													<input type="text" class="form-control" placeholder="Role" name="role" value="<?=$lig->role ;?>" required/>
												</div>  
											</div>  
										</div>                        
										<div class="form-group">                               
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												...
												<a class="dropdown-item" onclick= "return (confirm(' Voulez-vous supprimer vraiment cette information ?'));"  href="deleteuser.php?id=<?= $lig->id;?>"><i class="dw dw-delete-3"></i> Delete</a>											
											</div>
										</div>
									</td>
								</tr>
