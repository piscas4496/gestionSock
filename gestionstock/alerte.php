		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Alerte</li>
								</ol>
							</nav>
						</div>
						<div class="col-md-6 col-sm-12 text-right">							
								<!-- <button data-toggle="modal" data-target="#myModal" class="btn btn-primary">Add Alerte</button> -->
							
							<div id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
							<div role="document" class="modal-dialog">
							<div class="modal-content col-md-12">
								<div class="modal-header">
									<h5 id="exampleModalLabel" class="modal-title">Add Alerte</h5>
									<button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
								</div>
								<div class="modal-body">						
									<form id="forme" method="POST" Action="savealerte.php" class="form-horizontal" autocomplete="off">										
										<div class="row">
											<div class="col-md-11 ml-3">
												<div class="form-group">
													<label for="nom">Quantité</label>
													<input type="number" class="form-control" placeholder="Quantite" min="0" name="quantite" oninput="this.value = Math.abs(this.value)" required/>
												</div>												 
											</div>  
										</div>                        
										<div class="form-group">                               
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-blue h4">Quantité Alerte</h4>						
					</div>
					<div class="pb-20">
						<table class="data-table table stripe hover nowrap">
							...
							<div class="modal-content">
								<div class="modal-header">
									<h5 id="exampleModalLabel" class="modal-title">Update Alerte</h5>
									<button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
								</div>
								<div class="modal-body">						
									<form id="forme_edit" method="POST" Action="editalerte.php" class="form-horizontal" autocomplete="off">
									<input type="hidden" name="id" id="id" value="<?=$lig->id ;?>" class="form-control" required/>										
									    <div class="row">
											<div class="col-md-11 ml-3">
												<div class="form-group">
													<label for="nom">Quantité</label>
													<input type="number" class="form-control" placeholder="Quantite" name="quantite" oninput="this.value = Math.abs(this.value)" value="<?=$lig->quantite ;?>" required/>
												</div>												 
											</div>  
										</div>               
										<div class="form-group">                               
