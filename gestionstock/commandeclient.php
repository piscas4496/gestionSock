<?php
	...
	$query="SELECT * FROM commandeclient";
	$statement=$db->prepare($query);
	$statement->execute();
	$b=$statement->fetchAll(PDO::FETCH_OBJ);
    $query1 = $db->query("SELECT nom FROM client");
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Commandes clients</li>
								</ol>
							</nav>
						</div>
						<div class="col-md-12 col-sm-12 text-right">
							...
							<div class="modal-content">
								...
								<div class="modal-body col-md-12">						
									<form id="forme" method="POST" Action="addclient.php" class="form-horizontal col-md-12" autocomplete="off">										
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mt-3">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="tel" class="form-control" placeholder="+243 ... ... ..." name='telephone' min="0" oninput="this.value = Math.abs(this.value)" required />
                                                    </div>                             
                                                    <div class="form-group">
                ...
                <button data-toggle="modal" data-target="#myModal" class="btn btn-primary">Add Client</button>
					...
					<div class="pb-20">
						<table class="data-table table stripe hover nowrap">
							...
							<div class="modal-content">
								<div class="modal-header">
									<h5 id="exampleModalLabel" class="modal-title">Update Commandes clients</h5>
									<button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
								</div>
								<div class="modal-body col-md-12">						
									<form id="forme_edit" method="POST" Action="editcmdclient.php" class="form-horizontal" autocomplete="off">
									<input type="hidden" name="id" id="id" value="<?=$lig->id ;?>" class="form-control" required/>										
									<div class="row">
                                            <div class="col-md-6  mt-3 text-left">                            
                                                <div class="form-group">
                                                    <label for="client">Clients</label>
                                                    <select class="form-control" name="client" value="<?=$lig->client ;?>">
                                                        <option value="<?=$lig->client ;?>"><?=$lig->client ;?></option>                                                       
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    <label for="produit">Produit</label>
                                                ...
                                                <div class="form-group">
                                                    <label for="quantite">Quantité</label>
                                                    <input type="number" class="form-control" placeholder="quantité" name="quantite" min="0" oninput="this.value = Math.abs(this.value)" value="<?=$lig->quantite ;?>" />
                                                </div>                                                    
                                            </div>
                                            <div class="col-md-6  mt-3 text-left">  
                                                <div class="form-group">
                                                    <label for="prix">Prix unitaire</label>
                                                    <input type="number" class="form-control" placeholder="Prix unitaire" min="0" name="prix" oninput="this.value = Math.abs(this.value)" value="<?=$lig->prix ;?>"/>
                                                </div>                       
                                                <div class="form-group">
                                                    <label for="devise">Devise</label>
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												...
												<a class="dropdown-item" onclick= "return (confirm(' Voulez-vous supprimer vraiment cette information ?'));"  href="deletecmdclient.php?id=<?= $lig->id;?>"><i class="dw dw-delete-3"></i> Delete</a>											
											</div>
										</div>
									</td>
								</tr>
