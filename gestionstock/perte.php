<?php
	...
	$query="SELECT * FROM perteproduit";
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Perte Produit</li>
								</ol>
							</nav>
						</div>
						<div class="col-md-12 col-sm-12 text-right">							
								<button data-toggle="modal" data-target="#myModal" class="btn btn-primary">Add Perte</button>
							
							<div id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
							<div role="document" class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									<h5 id="exampleModalLabel" class="modal-title">Add Perte</h5>
					...
					<div class="pb-20">
						<table class="data-table table stripe hover nowrap">
							...
							<div class="modal-content">
								...
								<div class="modal-body col-md-12">						
									<form id="forme_edit" method="POST" Action="editperte.php" class="form-horizontal" autocomplete="off">
                                    ...
                                    <div class="row">
                                            <div class="col-md-12 ml-2">
                                                ...
                                                <div class="form-group">
                                                    <label for="dateActuel">Date</label>
                                                    <input type="date" class="form-control" placeholder="date perte" name="dateperte" value="<?=$lig->dateperte ;?>" />
                                                </div> 
                                                <div class="form-group">
                                                    <label for="quantite">Quantite</label>
                                                    <input type="number" class="form-control" min="0" placeholder="Quantité" name="quantite" value="<?=$lig->quantite ;?>" />
                                                </div>                                                                            
                                                <div class="form-group">
                                                    <label for="dateActuel">Type gaspillage</label>
                                                    <input type="text" class="form-control" placeholder="Type gaspillage" name="typegaspillage" value="<?=$lig->typegaspillage ;?>" />
                                                </div> 
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">												
                                                ...
                                                <a class="dropdown-item" onclick= "return (confirm(' Voulez-vous supprimer vraiment cette information ?'));"  href="deleteperte.php?id=<?= $lig->id;?>"><i class="dw dw-delete-3"></i> Delete</a>																							
											</div>
										</div>
									</td>
								</tr>
