...
function BasicTable()
{
	...
	// $this->Cell(190,12,'LES RESERVATIONS',1,0,'C');
		$this->Ln();
        $this->Cell(40,6,'username',1,0,'C');
		$this->Cell(50,6,'PASSWORD',1,0,'C');
		$this->Cell(40,6,'DATE',1,0,'C');
		// $this->Cell(25,6,'PRENOM',1,0,'C');
		$this->Cell(40,6,'email',1,0,'C');
		$this->Cell(20,6,'ROLE',1,0,'C');
	...
	while ($row = $req->fetch(PDO::FETCH_OBJ)) {
		...
		$this->Cell(50,8,$row->password,1,0,'C');
		$this->Cell(40,8,$row->created_at,1,0,'C');
		// $this->Cell(25,8,$row->prenom,1,0,'C');
		$this->Cell(40,8,$row->email,1,0,'C');
		$this->Cell(20,8,$row->role,1,0,'C');
