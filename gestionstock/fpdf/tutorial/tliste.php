...
function BasicTable()
{
	...
	$req=$db->query('SELECT * FROM tuteur');
	// $this->Cell(190,12,'LES RESERVATIONS',1,0,'C');
		$this->Ln();
		$this->Cell(40,6,'NOM',1,0,'C');
		$this->Cell(30,6,'POST-NOM',1,0,'C');
		// $this->Cell(25,6,'PRENOM',1,0,'C');
		//$this->Cell(30,6,'SEXE',1,0,'C');
		//$this->Cell(30,6,'CONTACT',1,0,'C');
		//$this->Cell(50,6,'ADRESSE',1,0,'C');
	...
	while ($row = $req->fetch(PDO::FETCH_OBJ)) {
		...
		$this->Cell(30,8,$row->postnom,1,0,'C');
		// $this->Cell(25,8,$row->prenom,1,0,'C');
		//$this->Cell(30,8,$row->sexe,1,0,'C');
		//$this->Cell(30,8,$row->contact,1,0,'C');
		//$this->Cell(50,8,$row->adresse,1,0,'C');
