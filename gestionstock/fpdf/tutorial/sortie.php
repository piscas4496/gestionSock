...
function BasicTable()
{
	...
	$req=$db->query('SELECT * FROM sortie');
	$this->Cell(190,12,'LISTE DES PRODUITS VENDUS',1,0,'C');
		$this->Ln();
		$this->Cell(10,6,'ID',1,0,'C');
		$this->Cell(50,6,'Client',1,0,'C');
		$this->Cell(30,6,'Produit',1,0,'C');
		// $this->Cell(25,6,'PRENOM',1,0,'C');
		$this->Cell(20,6,'QTE',1,0,'C');
		$this->Cell(20,6,'Prix',1,0,'C');
	...
	while ($row = $req->fetch(PDO::FETCH_OBJ)) {
		...
		$this->Cell(40,8,$row->dateoperation,1,0,'C');
