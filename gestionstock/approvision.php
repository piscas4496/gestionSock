	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				<div class="page-header">
					<div class="row">
						...
						<div class="col-md-12 col-sm-12 text-right">
                            <div class="container">
                                <form id="forme" method="POST" Action="saveapprovision.php" class="form-horizontal col-md-12" autocomplete="off">
                                    <div class="row">
				...
				<div class="card-box mb-50 container">  
				<a class="btn btn-primary offset-10" href="fpdf/tutorial/approv.php">Imprimer</a>              
					<div class="pd-20">
						<h4 class="text-blue h4">Liste des Approvisionnements</h4>                    						
					</div>
					<div class="pb-20">
						<table class="data-table table stripe hover nowrap">
							...
							<div class="modal-content">
								...
								<div class="modal-body col-md-12">						
									<form id="forme_edit" method="POST" Action="editapprovion.php" class="form-horizontal" autocomplete="off">
									<input type="hidden" name="id" id="id" value="<?=$lig->id ;?>" class="form-control" required/>										
                                        <div class="row">
                                            <div class="col-md-6  mt-3 text-left">                           
                                                ...
                                                <div class="form-group">
                                                    <label for="quantite">Quantité</label>
                                                    <input type="number" class="form-control" placeholder="quantité" min="0" name="quantite" oninput="this.value = Math.abs(this.value)" value="<?=$lig->quantite ;?>" />
                                                </div>                                                    
                                            </div>
                                            <div class="col-md-6  mt-3 text-left">  
                                                <div class="form-group">
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">												
												...
												<a class="dropdown-item" onclick= "return (confirm(' Voulez-vous supprimer vraiment cette information ?'));"  href="deleteprovision.php?id=<?= $lig->id;?>"><i class="dw dw-delete-3"></i> Delete</a>											
											</div>
										</div>
									</td>
								</tr>
